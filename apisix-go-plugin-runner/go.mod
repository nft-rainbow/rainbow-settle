...
require github.com/openweb3/go-rpc-provider v1.1.1 // indirect

require (
	github.com/Conflux-Chain/go-conflux-sdk v1.5.7-0.20230614083112-1c3791501e6e // indirect
	github.com/Conflux-Chain/go-conflux-util v0.0.0-20230112081533-651394b7ff5e // indirect
	...
	github.com/web3-identity/conflux-pay-sdk-go v0.1.2-beta.0.20230606023252-a2aa51d0e5cd // indirect
