...
const (
	...
	COST_TYPE_CONFURA_MAIN_CSPACE_NORMAL CostType = 10
	COST_TYPE_CONFURA_MAIN_ESPACE_NORMAL CostType = 11
	COST_TYPE_CONFURA_TEST_CSPACE_NORMAL CostType = 15
	COST_TYPE_CONFURA_TEST_ESPACE_NORMAL CostType = 16
...
func init() {
	CostTypeValue2StrMap = map[CostType]string{
		...
		COST_TYPE_CONFURA_MAIN_CSPACE_NORMAL: "confura_main_cspace_normal",
		COST_TYPE_CONFURA_MAIN_ESPACE_NORMAL: "confura_main_espace_normal",
		COST_TYPE_CONFURA_TEST_CSPACE_NORMAL: "confura_test_cspace_normal",
		COST_TYPE_CONFURA_TEST_ESPACE_NORMAL: "confura_test_espace_normal",
